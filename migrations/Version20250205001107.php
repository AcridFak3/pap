 ...
 */
final class Version20250205001107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD user_id_id INT DEFAULT NULL, DROP user_id');
    ...
    public function down(Schema $schema): void
    {
       ...
       // $this->addSql('DROP INDEX IDX_97A0ADA39D86650F ON ticket');
        $this->addSql('ALTER TABLE ticket ADD user_id INT NOT NULL, DROP user_id_id');
